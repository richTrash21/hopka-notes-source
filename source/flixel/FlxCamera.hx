...
/**
	rich here, heeded to remove inlining from containsRect() and containsPoint() cuz custom camera n' shit
	also implemented some flixel 6.0.0 stuff early (lol)
	SORRYY!!!!!
**/
...
class FlxCamera extends FlxBasic
{
	...
	// FROM MY PR AND IT GOT MERGED!!!!!! (https://github.com/HaxeFlixel/flixel/commit/1b6d3fd404bfca439ece1ef9a38ec7970564c1c7)
	...
	inline public function setFilters(filters:Array<BitmapFilter>):Void
	{
